...
Begin VB.Form frmLoading 
   ...
   Begin VB.Label lblStart 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Copyright © 2007 - 2008 BJ`s Software Studios"
      Height          =   255
      Index           =   1
      Left            =   600
      TabIndex        =   4
   ...
   Begin VB.Label lblMalang 
      BackColor       =   &H00FFFFFF&
      BackStyle       =   0  'Transparent
      Caption         =   "SENG NGGAWE WONG MALANG"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
    ...
    With prgLoad
        If .Value < 100 Then
            ...
            If .Value = 90 Then
                ...
                With frmMain
                    FillSystemOptimizer .lvwSystemOptimizer
                    CheckOptimizer .lvwSystemOptimizer
                    'Dim lReg As Long
                    ...
                    For i = 1 To VirusName.Count
                        .lstVirList.AddItem VirusName(i)
                    Next i
                End With
                Sleep 1000
                tmrStart.Enabled = True
